...
.detail-hero{display:grid;grid-template-columns:38% 62%;min-height:640px;border-bottom:1px solid var(--line);background:linear-gradient(120deg,#fbfaf6,#f3f1eb)}
...
.detail-image{min-height:640px;background:#e4e8e4}.detail-image img{height:100%;object-fit:cover;filter:saturate(.86) contrast(.95)}
...
@media(max-width:900px){.detail-hero,.detail-body,.detail-gallery,.detail-meta{grid-template-columns:1fr}.detail-image{min-height:420px}.detail-meta div,.detail-meta div:first-child{padding:22px var(--g);border-right:0;border-bottom:1px solid var(--line)}}
...
<header class="header"><a class="brand" href="/"><span class="mark">N</span><span>NSQUARE<small>VENTURES</small></span></a><nav class="nav" aria-label="Primary"><a href="/">Home</a><a class="active" href="/projects">Projects</a><a href="/expertise">Expertise</a><a href="/journal">Journal</a><a href="/contact">Contact</a></nav><div class="head-actions"><a class="inquire" href="/contact">Inquire <span>→</span></a><button class="menu-dot site-menu-trigger" type="button" aria-label="Open navigation">≡</button></div></header>
