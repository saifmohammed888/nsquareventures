    ...
    <>
      ...
      <main className="min-h-screen bg-neutral-50 text-black">
        ...
        <div className="mx-auto grid max-w-7xl gap-5 px-5 py-6 lg:grid-cols-[240px_1fr]">
          ...
          {tab === 'projects' && <ProjectsTab content={content} setContent={setContent} project={project} projectIndex={projectIndex} setProjectIndex={setProjectIndex} updateProject={updateProject} updateList={updateList} addListItem={addListItem} removeListItem={removeListItem} uploadImage={uploadImage} uploading={uploading} sync={sync} />}
          {tab === 'blogs' && <BlogsTab content={content} setContent={setContent} article={article} articleIndex={articleIndex} setArticleIndex={setArticleIndex} updateArticle={updateArticle} updateList={updateList} addListItem={addListItem} removeListItem={removeListItem} uploadImage={uploadImage} uploading={uploading} sync={sync} />}
          {tab === 'images' && <ImagesTab content={content} updateSite={updateSite} uploadImage={uploadImage} uploading={uploading} />}
