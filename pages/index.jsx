...
<section class="projects" id="projects">
	 ...
	 <div class="project-grid">
	  <div class="project-group">Ongoing Projects</div>
	  <a class="card" href="/project-detail?project=ravine-villa"><div class="card-image"><img src="Images/Elevation/Praveen Villa - Indiranagar.png" alt="Ravine Villa render"><img src="Images/wireframe.jpg" alt="Ravine Villa concept image"></div><div class="card-info"><h3>Ravine Villa</h3><p>Independent villa shaped around layered terraces, greenery and warm residential detailing.</p><div class="project-meta"><span><b>Client</b>Ravine Villa</span><span><b>Location</b>Indiranagar</span><span><b>Area</b>20,000 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=jaleel-complex"><div class="card-image"><img src="Images/Elevation/jaleel Complex RT Nagar.png" alt="Jaleel Complex render"><img src="Images/wireframe.jpg" alt="Jaleel Complex concept image"></div><div class="card-info"><h3>Jaleel Complex</h3><p>Mixed-use complex with a retail base, classical frontage and efficient upper-floor planning.</p><div class="project-meta"><span><b>Client</b>Jaleel Complex</span><span><b>Location</b>RT Nagar</span><span><b>Area</b>32,000 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=guzdar-apartment"><div class="card-image"><img src="Images/Elevation/Gulzar Apartment Bnaswadi.jpg" alt="Guzdar Apartment render"><img src="Images/wireframe.jpg" alt="Guzdar Apartment concept image"></div><div class="card-info"><h3>Guzdar Apartment</h3><p>Residential apartment with a strong street presence and carefully proportioned balconies.</p><div class="project-meta"><span><b>Client</b>Guzdar Apartment</span><span><b>Location</b>Banaswadi</span><span><b>Area</b>9,000 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=asif-apartment"><div class="card-image"><img src="Images/Elevation/ASIF Apartment  Frazer Town.jpg" alt="Asif Apartment render"><img src="Images/wireframe.jpg" alt="Asif Apartment concept image"></div><div class="card-info"><h3>Asif Apartment</h3><p>Tall urban apartment with vertical proportions, planted terraces and warm facade lighting.</p><div class="project-meta"><span><b>Client</b>Asif Apartment</span><span><b>Location</b>Fraser Town</span><span><b>Area</b>8,000 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=farooq-apartment"><div class="card-image"><img src="Images/Elevation/Farooq Apartment HBR.png" alt="Farooq Apartment render"><img src="Images/wireframe.jpg" alt="Farooq Apartment concept image"></div><div class="card-info"><h3>Farooq Apartment</h3><p>Contemporary apartment block with sculpted balconies, evening lighting and layered frontage.</p><div class="project-meta"><span><b>Client</b>Farooq Apartment</span><span><b>Location</b>HBR Layout</span><span><b>Area</b>11,000 sq ft</span></div><span class="arrow">→</span></div></a>
	  <div class="project-group">Completed Projects</div>
	  <a class="card" href="/project-detail?project=n-square-residence"><div class="card-image"><img src="Images/Elevation/Karamath Bellari.png" alt="N Square Residence site image"><img src="Images/Elevation/Ravi Villa.png" alt="N Square Residence concept image"></div><div class="card-info"><h3>N Square Residence</h3><p>Delivered residence with refined material choices, interior detailing and construction oversight.</p><div class="project-meta"><span><b>Owner</b>Private Client</span><span><b>Location</b>HBR Layout</span><span><b>Area</b>12,800 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=olive-court"><div class="card-image"><img src="Images/Elevation/Samhitha com.png" alt="Olive Court site image"><img src="Images/Elevation/Trillium School Arial.png" alt="Olive Court concept image"></div><div class="card-info"><h3>Olive Court</h3><p>Completed apartment interiors and common-space coordination for a clean residential experience.</p><div class="project-meta"><span><b>Owner</b>Olive Homes</span><span><b>Location</b>Hebbal</span><span><b>Area</b>24,500 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=cedar-house"><div class="card-image"><img src="Images/Elevation/Adil KHB.png" alt="Cedar House site image"><img src="Images/Elevation/Ayaz Khan Street.png" alt="Cedar House concept image"></div><div class="card-info"><h3>Cedar House</h3><p>Villa completed with architecture, interior detailing and on-site finishing control.</p><div class="project-meta"><span><b>Owner</b>Khan Family</span><span><b>Location</b>Whitefield</span><span><b>Area</b>9,600 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=metro-workspace"><div class="card-image"><img src="Images/Elevation/Reddy Commercial.png" alt="Metro Workspace site image"><img src="Images/Elevation/Moin Airtel - 16.png" alt="Metro Workspace concept image"></div><div class="card-info"><h3>Metro Workspace</h3><p>Workplace fit-out delivered with planning, material selection and execution coordination.</p><div class="project-meta"><span><b>Owner</b>Metro Build</span><span><b>Location</b>MG Road</span><span><b>Area</b>16,200 sq ft</span></div><span class="arrow">→</span></div></a>
	  <a class="card" href="/project-detail?project=palm-enclave"><div class="card-image"><img src="Images/Elevation/Firoz Service.png" alt="Palm Enclave site image"><img src="Images/Elevation/zabi hbr night.jpg" alt="Palm Enclave concept image"></div><div class="card-info"><h3>Palm Enclave</h3><p>Completed residential project integrating approvals, construction and finishing under one team.</p><div class="project-meta"><span><b>Owner</b>Palm Estates</span><span><b>Location</b>Jayanagar</span><span><b>Area</b>28,000 sq ft</span></div><span class="arrow">→</span></div></a>
	 </div>
